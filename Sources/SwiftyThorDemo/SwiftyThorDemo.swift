/// SwiftyThorDemo — animated macOS app that draws moving shapes
/// via ThorVG's GlCanvas backed by ANGLE (Metal).
...
@main
class SwiftyThorDemo: NSApplication {
